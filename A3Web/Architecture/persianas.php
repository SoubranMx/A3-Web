...
$(document).ready(function(){
  $("#p1").click(function(){
    $("#persiana1").css("display","block");
    $("#persiana2").css("display","none");
    $("#persiana3").css("display","none");
    $("#persiana4").css("display","none");
    $("#persiana5").css("display","none");
    $("#persiana6").css("display","none");
    $("#persiana7").css("display","none");
    $("#persiana8").css("display","none");
    $("#persiana9").css("display","none");
    $("#persiana10").css("display","none");
    $("#persiana11").css("display","none");
    $("#persiana12").css("display","none");
     $("#infopersiana").css("display","none");
   });
   $("#p2").click(function(){
    $("#persiana2").css("display","block");
    ...
    $("#persiana2").css("display","none");
     $("#infopersiana").css("display","none");
			...
			<div id="slideshow" class="pics" style="height:400px; ">
        			...
        			<img src="persianas/4.jpg"  style="top: 0px; left: 0px; z-index: 5; position: absolute; display: none; ">
        ...
        <li class=""><a href="#" id="p2"><img src="persianas/2.jpg" width="80" height="53"></a></li>
        <li class=""><a href="#" id="p3"><img src="persianas/3.jpg" width="80" height="53"></a></li>
        <li class=""><a href="#" id="p4"><img src="persianas/4.jpg" width="80" height="53" ></a></li>
		...
		<div id="persiana4" style="display:none;">Enrrollable</div>
		<div id="persiana5" style="display:none;">Enrollable Room Darkening</div>
		<div id="persiana6" style="display:none;">Horizontal Precious Metals</div>
		<div id="persiana7" style="display:none;">Country Woods</div>
		<div id="persiana8" style="display:none;">Plisada</div>
		<div id="persiana9" style="display:none;">Romana</div>
