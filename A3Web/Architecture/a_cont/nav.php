<div id="nava">
	<ul>
		...
		<li> <a href="#">Residencial</a> 
			<ul>
				<li><a href="obra_mangos.php">Los Mangos</a></li>
				<li><a href="obra_rancho_la_paz.php">Rancho La Paz</a></li>
				<li><a href="obra_san_pedro.php">San Pedro</a></li>
				<li><a href="obra_mangles.php">Mangles</a></li>
				<li><a href="obra_goldsmith.php">Goldsmith</a></li>
				<li><a href="obra_real_del_country.php">Real del Country</a></li>
				<li><a href="obra_jacarandas.php">Jacarandas</a></li>
				<li><a href="obra_sierra_teide.php">Sierra Teide</a></li>
				<li><a href="obra_rancho_recoveco.php">Rancho Recoveco</a></li>
			</ul>
		</li>
                <li> <a href="#">Comercial</a>
                	<ul>
				<li><a style="" href="obra_restaurante_central.php">Central Central</a></li>
