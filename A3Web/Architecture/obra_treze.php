	   ...
	   <div id="proyectos">
				...
				<div id="slideshow" class="pics" style="height:400px; ">
	  			...
	  			<img src="obras/obwinpalace/Winpalace03.jpg" width="629" height="429" style="top: 0px; left: 0px; z-index: 6; position: absolute; display: none; ">
					...
					<img src="obras/obwinpalace/Winpalace05.jpg" width="629" height="429" style="top: 0px; left: 0px; z-index: 4; position: absolute; display: none; ">
					<img src="obras/obwinpalace/Winpalace06.jpg" width="629" height="429" style="top: 0px; left: 0px; z-index: 4; position: absolute; display: none; ">
			...
			<div style="position:relative;width:255px; border-top:1px solid #fff; padding-top:10px; float:right; bottom:0px;">
				Casino Winpalace, 2000 m2	<br>
				Ciudad Satélite, Edomex (2015)	<br>
				Rediseño y decoración de interiores	<br>
				Creación de fachada	<br>
				Cuando hablamos de arquitectura, la materia prima es el espacio. En Winpalace Casino, la materia prima es la luz. La luz forma el espacio, y no al revés.	<br>
